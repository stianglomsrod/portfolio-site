...
import styles from "./KlarCase.module.css";

const content = {
  no: {
    label: "Hovedprosjekt",
    title: "Klar — et fullstack AI-produkt, bygget i praksis",
    lede: "Klar er en fullstack PWA-prototype som støtter struktur, prioritering og hjelp underveis i skolehverdagen. Den viser hvordan brukerbehov kan oversettes til konkrete systemvalg i et fullstack-produkt.",
    ...
    disclaimer:
      "Klar er en fungerende prototype i full bredde, men ikke en ferdig plattform i stor skala. Evalueringen ble gjort med lærere, ikke elever, og det er en bevisst og dokumentert avgrensning.",
  },
  en: {
    label: "Main project",
    title: "Klar — a full-stack AI product, built for real",
    lede: "Klar is a full-stack PWA prototype that supports structure, prioritisation and help during the school day. It shows how user needs can be translated into concrete system choices in a full-stack product.",
    ...
    disclaimer:
      "Klar is a working, full-width prototype, but not a finished platform at large scale. The evaluation was done with teachers, not students, and that's a deliberate, documented limitation.",
  },
} as const;

export default function KlarCase() {
