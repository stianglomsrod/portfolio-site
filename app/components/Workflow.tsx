...
const content = {
  no: {
    ...
    relevance:
      "Jeg har skrevet ned denne arbeidsmåten slik at et team kan plukke den opp og bruke den. Det er enablement i praktisk skala.",
  ...
  en: {
    ...
    relevance:
      "I've written this way of working down so a team can pick it up and use it. That's enablement at a practical scale.",
