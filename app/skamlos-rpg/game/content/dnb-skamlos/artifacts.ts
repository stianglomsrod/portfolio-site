...
export const artifacts: Artifact[] = [
  ...
  },
  {
    ...
    description: {
      no: "Robust fullstack AI-prototype, bygget som masterprosjekt.",
      en: "Robust fullstack AI prototype, built as the master's project.",
    },
    kind: "concept",
  },
  {
  ...
  {
    id: "dnb-portefolje",
    title: { no: "DNB-porteføljeside", en: "DNB portfolio site" },
    description: {
