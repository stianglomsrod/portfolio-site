...
export default function RewardBanner({ reward, lang }: Props) {
  return (
    <div className={styles.rewardBanner} role="status">
      <p className={styles.rewardKicker}>{lang === "no" ? "Belønning" : "Reward"}</p>
      {reward.skills.map((s) => (
        <div key={s.id} className={styles.rewardItem}>
          ...
          <div>
            ...
            <span className={styles.rewardSub}>{lang === "no" ? "Ny ferdighet" : "New skill"}</span>
          </div>
        </div>
      ))}
        ...
        <div key={a.id} className={styles.rewardItem}>
          ...
          <div>
            ...
            {a.href && (
              ...
              >
                {a.linkLabel ? t(a.linkLabel, lang) : lang === "no" ? "Åpne" : "Open"} ↗
              </a>
            )}
