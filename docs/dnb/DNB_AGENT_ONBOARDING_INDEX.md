...
3. `docs/dnb/DNB_WORKFLOW_DNA.md`
4. `docs/dnb/DNB_POSITIONING.md`
5. `docs/dnb/DNB_QA_CHECKLIST.md`
6. `docs/dnb/DNB_CONTENT_OUTLINE.md`
7. `docs/dnb/DNB_SECTION_COPY_V1.md`
8. `docs/dnb/DNB_AGENT_HANDOFF_PROTOCOL.md`
9. `docs/dnb/DNB_COST_CONTROL.md`
10. `docs/dnb/DNB_IMPLEMENTATION_LOG.md`
11. `FILE_TREE.md`

## Job posting source note
The exact DNB job posting text is not currently stored as a dedicated file in this repo.

Use `docs/dnb/DNB_POSITIONING.md` and `docs/dnb/DNB_WORKFLOW_DNA.md` as the canonical proxy for role-fit language until the exact posting text is added.

If needed, ask the user to provide the exact posting content and then add a source file reference.
