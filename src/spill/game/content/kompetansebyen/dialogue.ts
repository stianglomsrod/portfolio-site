...
export const dialogue: Record<string, DialogueTree> = {
  ...
  kari: [
    ...
    },
    {
      speaker: { no: "Kari" },
      text: {
        no: "Du burde ta turen til Drømmejobben nord i byen. Det miljøet tror jeg kan passe deg.",
        en: "You should head for Drømmejobben up north. I think that environment could suit you.",
      },
    },
  ],
  "resepsjon-egg": [
  ...
  "oslomet-klar": [
    ...
    {
      text: {
        no: "En prototype, ikke en ferdig plattform. Poenget var å bevise ideen.",
        en: "A prototype, not a finished platform. The point was to prove the idea.",
      },
    },
  ],
  "oslomet-method": [
