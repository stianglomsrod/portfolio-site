...
export const minigames: MinigameDef[] = [
  ...
  },
  {
    ...
    config: {
      ...
      outro: {
        no: "Porteføljen er klar. Drømmejobben tar bare imot komplette søknadspakker — nå har du en. Gå og lever den.",
        en: "The portfolio is ready. Drømmejobben only accepts complete application packages — now you have one. Go deliver it.",
      },
    },
  },
  {
