...
const LABELS = {
  no: {
    ...
    moveValTouch: "Trykk dit du vil gå — eller pilknappene",
    act: "Snakk / undersøk",
    actVal: "E eller mellomrom",
    actValTouch: "Trykk på personer og ting — eller E-knappen",
  ...
  en: {
    ...
    moveValTouch: "Tap where you want to go — or the arrows",
    act: "Talk / inspect",
    actVal: "E or space",
    actValTouch: "Tap people and things — or the E button",
    logs: "Quests / skills",
    logsVal: "Q / K",
